      ...
      <div className="row">
        ...
        <div className="col body1">
          <div className="d-flex pt-5 ps-5">
            ...
            <div className="Exclamation pe-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <div className="row justify-content-center">
            <div className="col ps-5 pt-4">
              <div class="card bg-success text-white p-4 card1">
                <div class="card-body">
                  <p>Weekly Sales</p>
            ...
            <div className="col pt-4">
              <div class="card bg-warning text-white p-4 card2">
                <div class="card-body">
                  <p>Weekly Orders</p>
            ...
            <div className="col pt-4">
              <div class="card bg-info text-white p-4 card3">
                <div class="card-body">
                  <p>vistors Online</p>
